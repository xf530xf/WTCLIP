...
parser.add_argument("--config",
                    ...
                    type=str,
                    help="config")
parser.add_argument("--work_dir", default="/data2/XF/KeYan/WeCLIP/results", type=str, help="work_dir")
...
parser.add_argument("--model_path", default="/data2/XF/KeYan/WeCLIP/work_dir_coco/checkpoints/2025-01-05-19-26/WeCLIP_model_iter_80000.pth",
