...
parser.add_argument("--config",
                    ...
                    type=str,
                    help="config")
parser.add_argument("--work_dir", default="results5", type=str, help="work_dir")
...
############################################################################
        # imageio.imsave(os.path.join(args.work_dir, "cam_images2", f"{name[0]}_{idx}.png"), segs_cat.cpu().detach().numpy())
