...
class_name_cod=['Deer', 'FrogFish', 'Heron', 'Tiger', 'Lizard', 'Chameleon', 'Bat', 'Sciuridae', 'ScorpionFish', 'Ant', 'Reccoon', 'Spider', 'Gecko', 'Dog', 'Cicada', 'Lion', 'Cat', 'Kangaroo', 'Sheep', 'Monkey', 'Bug', 'Grasshopper', 'Human', 'StickInsect', 'Octopus', 'Centipede', 'Moth', 'Butterfly', 'Mockingbird', 'Owl', 'LeafySeaDragon', 'GhostPipefish', 'Dragonfly', 'Leopard', 'ClownFish', 'BatFish', 'Rabbit', 'Shrimp', 'StarFish', 'Turtle', 'Beetle', 'Frog', 'Wolf', 'Bird', 'Duck', 'Frogmouth', 'Grouse', 'Worm', 'Cheetah', 'Slug', 'Crocodile', 'Bittern', 'Caterpillar', 'Toad', 'Snake', 'Crab', 'Giraffe', 'Pipefish', 'SeaHorse', 'Mantis', 'Flounder', 'Bee', 'Fish', 'Katydid']

new_class_names_cod = ['Deer', 'FrogFish', 'Heron', 'Tiger', 'Lizard', 'Chameleon', 'Bat', 'Sciuridae', 'ScorpionFish', 'Ant', 'Reccoon', 'Spider', 'Gecko', 'Dog', 'Cicada', 'Lion', 'Cat', 'Kangaroo', 'Sheep', 'Monkey', 'Bug', 'Grasshopper', 'Human', 'StickInsect', 'Octopus', 'Centipede', 'Moth', 'Butterfly', 'Mockingbird', 'Owl', 'LeafySeaDragon', 'GhostPipefish', 'Dragonfly', 'Leopard', 'ClownFish', 'BatFish', 'Rabbit', 'Shrimp', 'StarFish', 'Turtle', 'Beetle', 'Frog', 'Wolf', 'Bird', 'Duck', 'Frogmouth', 'Grouse', 'Worm', 'Cheetah', 'Slug', 'Crocodile', 'Bittern', 'Caterpillar', 'Toad', 'Snake', 'Crab', 'Giraffe', 'Pipefish', 'SeaHorse', 'Mantis', 'Flounder', 'Bee', 'Fish', 'Katydid']


BACKGROUND_CATEGORY_COD =['ground','land','grass','tree','building','wall','sky','lake','water','river','sea','railway','railroad','keyboard','helmet',
                        'cloud','house','mountain','ocean','road','rock','street','valley','bridge','sign',
                        ]
